...
<html lang="en">
	...
	d3.csv("merged_db_20130313.csv", function(error, data) { // third
        ...
        workData.remove(function(el) { return el.country === "Uganda"; });
    ...
    function removeTest(workData2) {
        ...
        console.log("new workData2: ");
        console.log(workData2);
        
        
          var bla =   d3.select("#grouped-bars").selectAll("g.countrybars");
                               // .data(workData2, function(d) { return(d); });
